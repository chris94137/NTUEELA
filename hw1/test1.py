...
def main():
    ...
    for i in range(len(sets1)):
        for j in range(len(sets1[i])):
            print("{:3s}".format("".join(str(sets1[i][j]))), end = '')
        print('')
    for j in range(3 * len(sets1[0])):
        print('-', end = '')
    print('')
    if has_cycle(sets1):
        print('Yes')
    ...
    for i in range(len(sets2)):
        for j in range(len(sets2[i])):
            print("{:3s}".format("".join(str(sets2[i][j]))), end = '')
        print('')
    for j in range(3 * len(sets1[0])):
        print('-', end = '')
    print('')
    ...
    for i in range(len(sets3)):
        for j in range(len(sets3[i])):
            print("{:3s}".format("".join(str(sets3[i][j]))), end = '')
        print('')
    for j in range(3 * len(sets1[0])):
        print('-', end = '')
    print('')
